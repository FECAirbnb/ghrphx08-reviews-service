...
const reviewSampleData = [
  {
    review_date: `${fake.date.month()} ${fake.random.number({ min: 2019, max: 2020 })}`,
    review_body:
    ...
    overall_star_rating: fake.random.number({ min: 1, max: 5 }),
    cleanliness_rating: fake.random.number({ min: 1, max: 5 }),
    communication_rating: fake.random.number({ min: 1, max: 5 }),
    check_in_rating: fake.random.number({ min: 1, max: 5 }),
    accuracy_rating: fake.random.number({ min: 1, max: 5 }),
    location_rating: fake.random.number({ min: 1, max: 5 }),
    value_rating: fake.random.number({ min: 1, max: 5 }),
    locationId: 1,
    userId: 5
  },
  {
  ...
  {
    review_date: `${fake.date.month()} ${fake.random.number({ min: 2019, max: 2020 })}`,
    review_body: fake.lorem.paragraphs(3),
    overall_star_rating: fake.random.number({ min: 1, max: 5 }),
    cleanliness_rating: fake.random.number({ min: 1, max: 5 }),
    communication_rating: fake.random.number({ min: 1, max: 5 }),
    check_in_rating: fake.random.number({ min: 1, max: 5 }),
